...
namespace GrocerySite.pages
{
    public partial class Delete : System.Web.UI.Page
    {
        ...
        //Delete entered Pid Row
        protected void delItm_Click(object sender, EventArgs e)
        {
            try
            {
                if (Pid.Text != "")
                {
                    ...
                    string deleteQ = "DELETE FROM contTB WHERE Pid = "+ pidtxt;
                ...
                {
                    delRes.Text = "Please Enter a PID";
                    delRes.Visible = true;
                }
            }
            catch(Exception ex)
